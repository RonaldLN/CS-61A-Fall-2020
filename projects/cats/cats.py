...
def autocorrect(user_word, valid_words, diff_function, limit):
    ...
    if user_word in valid_words:
        return user_word
    similar_word = min(valid_words, key=lambda x: diff_function(user_word, x, limit))
...
def shifty_shifts(start, goal, limit):
    ...
    #     return len(start)
    # else:
    #     temp = shifty_shifts(start[1:], goal[1:], limit)
    #     if temp > limit:
    #         return temp
    #     else:
    #         return temp if start[0] == goal[0] else temp + 1
