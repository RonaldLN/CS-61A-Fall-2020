...
def roll_dice(num_rolls, dice=six_sided):
    ...
    while num_rolls:
        ...
        sum += tmp
        num_rolls -= 1
    return 1 if is_one_got else sum
    # END PROBLEM 1
...
def swine_align(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 4a
    "*** YOUR CODE HERE ***"
    GCD = player_score if player_score < opponent_score else opponent_score
    if not GCD:
        return False
    else:
        while GCD > 1:
    ...
    while score0 < goal and score1 < goal:
        if not who:
            ...
            if score0 >= goal:
                ...
                someone_win = True
            elif not extra_turn(score0, score1):
                # who = (who + 1) % 2
                who = 1 - who
            #     score0 += take_turn(strategy0(score0, score1), score1, dice)
            #     if score0 >= goal:
            ...
            if score1 >= goal:
                # return score0, score1
                someone_win = True
            elif not extra_turn(score1, score0):
                # who = (who + 1) % 2
                who = 1 - who
            #     score1 += take_turn(strategy1(score1, score0), score0, dice)
            #     if score1 >= goal:
...
def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    ...
    while i <= 10:
        ...
        while j < trials_count:
            ...
            j += 1
        if sum / trials_count > max_average_score:
            max_average_score = sum / trials_count
            best_nums_rolls = i
        i += 1
